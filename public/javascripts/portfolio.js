  ...
  if(title.includes("INTERNAL FPG SALES PORTAL")){
      ...
      $('.portfolio .portfolio-content').html("<div class='col-8'> \n"
                                              +"<a href='#'>\n"
                                               ...
                                               +"</div>\n"
                                               +"<div class='col'>\n"
                                                 +"<h2 class='projectname'> PROJECT NAME: EXPENSE ALLOCATION METICS WINDOWS DESKTOP APPLICATION</h2>\n"
      ...
      $('.portfolio .portfolio-content').html("<div class='col-8'> \n"
                                              +"<a href='gerfusa'>\n"
                                               ...
                                               +"<div class='col'>\n"
                                                 ...
                                                 +"<p class='role'> ROLE: Designer, front & back-end coder, database architect </p>\n"
                                                 +"<p class='skills'> TECHNOLOGIES: NodeJS, HTML, CSS, JQuery, MongoDB, Express, MailChimp, Mandrill,Heroku</p>\n"
                                                 +"<p class='description'> DESCRIPTION: This web application is for a service and errands company which will enable customers to buy and schedule groceries/errands. It also has a customer chat interface plus a employee portal to facilitate retrieving past orders and other company/customer data.</p>"
                                                 +"<a href='https://github.com/tmudarikwa/GERFUSA' target='_blank'>\n"
                                                 +"<p class='link'>GITHUB: https://github.com/tmudarikwa/GERFUSA</p>\n"
                                                 +"<p class='link'>LINK: \n"
                                                 +"<a href='http://salty-mountain-65693.herokuapp.com/' title='GERF website' target='_blank'>http://salty-mountain-65693.herokuapp.com/</a></p>\n"
